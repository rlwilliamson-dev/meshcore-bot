...
class WxCommand(BaseCommand):
    ...
    def _get_weather_for_location_sync(self, location: str, location_type: str, forecast_type: str = "default", num_days: int = 7, message: MeshMessage = None, using_companion_location: bool = False, reserve: int = 0) -> str:
